 ...
 //////////////////////// 
        ...
        if($command == "เตือนภัยเกษตรล่าสุด"){
          $uriw = "https://chaokaset.openservice.in.th/index.php/doaservices/notifysent";
            ...
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][1]['contents'][0]['text'] = "จังหวัด";
            ...
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][2]['contents'][0]['text'] = "จังหวัด";
            ...
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][3]['contents'][0]['text'] = "จังหวัด";
            ...
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][4]['contents'][0]['text'] = "จังหวัด";
            ...
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][5]['contents'][0]['text'] = "จังหวัด";
