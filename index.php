 ...
 //////////////////////// 
        ...
        if($command == "เตือนภัยเกษตรล่าสุด"){
          $uriw = "https://chaokaset.openservice.in.th/index.php/doaservices/notifysent";
            ...
            $arrayPostData['messages'][0]['contents']['contents'][$i]['styles']['header']['backgroundColor'] = "#25BAC8";
            ...
            $datacountrowtype += 1;
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][1]['type'] = "box";
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][1]['layout'] = "baseline";
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][1]['contents'][0]['type'] = "text";
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][1]['contents'][0]['text'] = "สภาพแวดล้อม : ";
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][1]['contents'][0]['flex'] = $i;
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][1]['contents'][0]['size'] = "md";
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][1]['contents'][0]['weight'] = "bold";
            // $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][1]['contents'][0]['wrap'] = true;
            $datacountrowtype += 1;
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][1]['contents'][1]['type'] = "text";
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][1]['contents'][1]['text'] = "$weather";
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][1]['contents'][1]['flex'] = $i;
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][1]['contents'][1]['size'] = "md";
            ...
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][2]['layout'] = "baseline";
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][2]['contents'][0]['type'] = "text";
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][2]['contents'][0]['text'] = "ระยะการเจริญเติบโต : ";
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][2]['contents'][0]['flex'] = $i;
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][2]['contents'][0]['size'] = "md";
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][2]['contents'][0]['weight'] = "bold";
            // $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][2]['contents'][0]['wrap'] = true;
            $datacountrowtype += 1;
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][2]['contents'][1]['type'] = "text";
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][2]['contents'][1]['text'] = "$growing";
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][2]['contents'][1]['flex'] = $i;
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][2]['contents'][1]['size'] = "md";
            ...
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][3]['layout'] = "baseline";
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][3]['contents'][0]['type'] = "text";
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][3]['contents'][0]['text'] = "ปัญหาที่ควรระวัง : ";
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][3]['contents'][0]['flex'] = $i;
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][3]['contents'][0]['size'] = "md";
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][3]['contents'][0]['weight'] = "bold";
            // $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][3]['contents'][0]['wrap'] = true;
            $datacountrowtype += 1;
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][3]['contents'][1]['type'] = "text";
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][3]['contents'][1]['text'] = "$problem";
            ...
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][4]['layout'] = "baseline";
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][4]['contents'][0]['type'] = "text";
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][4]['contents'][0]['text'] = "อาการที่อาจพบ : ";
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][4]['contents'][0]['flex'] = $i;
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][4]['contents'][0]['size'] = "md";
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][4]['contents'][0]['weight'] = "bold";
            // $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][4]['contents'][0]['wrap'] = true;
            $datacountrowtype += 1;
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][4]['contents'][1]['type'] = "text";
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][4]['contents'][1]['text'] = "$warning";
            ...
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][5]['layout'] = "baseline";
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][5]['contents'][0]['type'] = "text";
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][5]['contents'][0]['text'] = "แนวทางป้องกัน : ";
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][5]['contents'][0]['flex'] = $i;
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][5]['contents'][0]['size'] = "md";
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][5]['contents'][0]['weight'] = "bold";
            // $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][5]['contents'][0]['wrap'] = true;
            $datacountrowtype += 1;
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][5]['contents'][1]['type'] = "text";
            $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][5]['contents'][1]['text'] = "$solution";
            ...
            ////////////////////////////////////////////////////////
            // $datacountrowtype += 1;
            // $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][1]['contents'][3]['type'] = "text";
            // $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][1]['contents'][3]['text'] = "ระยะทาง กิโลเมตร";
            // $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][1]['contents'][3]['flex'] = $i;
            // $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][1]['contents'][3]['size'] = "md";
            // $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][1]['contents'][3]['wrap'] = true;
            // $datacountrowtype += 1;
            // $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][1]['contents'][4]['type'] = "text";
            // $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][1]['contents'][4]['text'] = "อัปเดตล่าสุด ";
            // $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][1]['contents'][4]['flex'] = $i;
            // $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][1]['contents'][4]['size'] = "md";
            // $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][1]['contents'][4]['wrap'] = true;   
            // $datacountrowtype += 1;
            // $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][1]['contents'][5]['type'] = "text";
            // $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][1]['contents'][5]['text'] = "แหล่งที่มา :";
            // $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][1]['contents'][5]['flex'] = $i;
            // $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][1]['contents'][5]['size'] = "md";
            // $arrayPostData['messages'][0]['contents']['contents'][$i]['body']['contents'][0]['contents'][1]['contents'][5]['wrap'] = true;   
            // $datacountrowtype += 1;
